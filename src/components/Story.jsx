...
const Story = ({ index, id, usrname, url }) => {
  return (
    <Link to={`/instagram-ui-clone/story/${usrname}`} state={{ userid: id, index: index,usrname:usrname }}>
      <div className="w-16 h-fit flex flex-col items-center cursor-pointer">
